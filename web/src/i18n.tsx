...
const messages: Record<string, { "zh-CN": Message; en: Message }> = {
  ...
  "Library home": { "zh-CN": "书库首页", en: "Library home" },
  ...
  "Close reader settings": { "zh-CN": "关闭阅读器设置", en: "Close reader settings" },
  ...
  "No contents available": { "zh-CN": "这本书没有可用目录。", en: "No contents available." },
  "Close pages": { "zh-CN": "关闭页面缩略图", en: "Close page thumbnails" },
  "No pages available": { "zh-CN": "没有可用页面。", en: "No pages available." },
